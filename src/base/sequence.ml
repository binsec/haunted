...
let peek_front_ex t = qpeek_front t.queue
let peek_back_ex t = qpeek_back t.queue

let pop_front_ex t = { length = t.length - 1; queue = qpop_front t.queue }
let pop_back_ex t = { length = t.length - 1; queue = qpop_back t.queue }
